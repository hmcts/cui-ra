...
When(/^I select all the options and click Continue$/, async function () {
  ...
  await I.click('#_enabled-PF0001-RA0001-RA0004-RA0021');
...
When(/^I select all the options and continue to next page$/, async function () {
  ...
  await I.click('#_enabled-PF0001-RA0001-RA0002-RA0011');
  await I.click('#_enabled-PF0001-RA0001-RA0002-RA0013');
